...
circuit.V(1,  1 ,  0 ,   10@u_V )           # .V(label, +nó, -nó, val)
circuit.R(1,  1 , 'a',  100@u_Ω )           # .R(label,  nó,  nó, val)
circuit.C(1, 'o',  0 ,    1@u_mF)           # .C(label,  nó,  nó, val, <ic = 1@u_V>) -> use_initial_condition = True
#############################################

################## Chaves ###################
t0, tf, st, t_swt = -.5@u_s, 1@u_s, .1@u_ms, 0@u_s
