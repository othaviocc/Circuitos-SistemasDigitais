...
HD_PWD='C:/Users/Aluno/Documents/project_12/project_12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topo.tcl -notrace
