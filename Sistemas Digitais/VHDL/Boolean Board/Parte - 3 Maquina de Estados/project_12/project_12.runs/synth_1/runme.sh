...
HD_PWD='C:/Users/Aluno/Documents/project_12/project_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topo.tcl
