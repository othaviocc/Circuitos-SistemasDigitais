...
architecture comportamental of maquina_de_estados is
    ...
    -- por valores
    constant VALOR1 : std_logic_vector(7 downto 0) := std_logic_vector(to_unsigned(10, 8));
    constant VALOR2 : std_logic_vector(7 downto 0) := std_logic_vector(to_unsigned(20, 8));
    constant VALOR3 : std_logic_vector(7 downto 0) := std_logic_vector(to_unsigned(30, 8));
    constant VALOR4 : std_logic_vector(7 downto 0) := std_logic_vector(to_unsigned(40, 8));
    -- tempo
...
begin
    ...
    begin
        if i_reset = '1' then
            ...
            -- Contador de 3s, ous eja, se o estado atual é diferente do proximo estadop muda 
